...
class Processing:
    ...
    def extract_time_info(self,message):
        ...
        # Check if the list has at least two elements before accessing index 1
    ...
    def get_all_device_with_descriptions(self, input_csv_path):
        '''
        only use if the input csv is in this format:
        
        timestamp	source	message
2024-06-11T11:54:07.059Z	syslog	Jun 11 2024 11:52:42 GPN-0003_TRC-CR_X8-01 %%01OSPF/4/CONFLICT_ROUTERID_INTF(l):CID=0x8082047e;OSPF router ID conflict is detected on the interface.(ProcessId=801, RouterId=10.0.0.10, AreaId=0.0.0.0, InterfaceName=GigabitEthernet6/0/11.801, IpAddr=10.0.0.22, PacketSrcIp=10.0.0.10)
        ...
        with open(input_csv_path, mode='r', newline='', encoding='utf-8') as infile:
            ...
            for row in csv_reader:
                ...
                all_descriptions.append(extracted_data.get('device_with_description', '').lower().strip())   
...
2024-06-11T11:54:07.059Z	syslog	Jun 11 2024 11:52:42 GPN-0003_TRC-CR_X8-01 %%01OSPF/4/CONFLICT_ROUTERID_INTF(l):CID=0x8082047e;OSPF router ID conflict is detected on the interface.(ProcessId=801, RouterId=10.0.0.10, AreaId=0.0.0.0, InterfaceName=GigabitEthernet6/0/11.801, IpAddr=10.0.0.22, PacketSrcIp=10.0.0.10)
        ...
        with open(input_csv_path, mode='r', newline='', encoding='utf-8') as infile:
            ...
            for row in csv_reader:
                ...
                all_descriptions.append(extracted_data.get('description', '').lower().strip())   
...
2024-06-11T11:54:07.059Z	syslog	Jun 11 2024 11:52:42 GPN-0003_TRC-CR_X8-01 %%01OSPF/4/CONFLICT_ROUTERID_INTF(l):CID=0x8082047e;OSPF router ID conflict is detected on the interface.(ProcessId=801, RouterId=10.0.0.10, AreaId=0.0.0.0, InterfaceName=GigabitEthernet6/0/11.801, IpAddr=10.0.0.22, PacketSrcIp=10.0.0.10)
    ...
    def get_specific_device_with_descriptions_formatted(self, input_csv_path, physical_site_id, geolocation_code, device_role, device_model_number):
        '''
...
Sep 24 2024 10:02:04	2024	9	24	10	2	4	0	1	268	39	0	36124	Morning	GPN-0001-TLK-CR--M14-01	GPN	1	TLK	CR		M14	1	1	SSH	5	SSH_USER_LOGIN	(s)	0x80930446			The SSH user succeeded in logging in. 	GPN-0001-TLK-CR--M14-01 -> The SSH user succeeded in logging in. 	ServiceType=snetconf, UserName=nms_admin, UserAddress=172.31.25.125, LocalAddress=172.31.0.3, VPNInstanceName=_public_	
    ...
    def extract_network_info(self,pattern,message):
        '''
        only use if the message is in this format:
        
        Jun 11 2024 11:52:42 GPN-0003_TRC-CR_X8-01 %%01OSPF/4/CONFLICT_ROUTERID_INTF(l):CID=0x8082047e;OSPF router ID conflict is detected on the interface.(ProcessId=801, RouterId=10.0.0.10, AreaId=0.0.0.0, InterfaceName=GigabitEthernet6/0/11.801, IpAddr=10.0.0.22, PacketSrcIp=10.0.0.10)
    ...
    def end_to_end_processing(self, input_csv_path, output_csv_path, insert_mode = 'w'):
        '''
        only use if the input csv is in this format:
...
2024-06-11T11:54:07.059Z	syslog	Jun 11 2024 11:52:42 GPN-0003_TRC-CR_X8-01 %%01OSPF/4/CONFLICT_ROUTERID_INTF(l):CID=0x8082047e;OSPF router ID conflict is detected on the interface.(ProcessId=801, RouterId=10.0.0.10, AreaId=0.0.0.0, InterfaceName=GigabitEthernet6/0/11.801, IpAddr=10.0.0.22, PacketSrcIp=10.0.0.10)
        ...
        with open(input_csv_path, mode='r', newline='', encoding='utf-8') as infile, \
            open(output_csv_path, mode= insert_mode, newline='', encoding='utf-8') as outfile:
    ...
    def append_processed_data(self,input_csv_path, output_csv_path):
        '''
        only use if the input csv is in this format:
...
2024-06-11T11:54:07.059Z	syslog	Jun 11 2024 11:52:42 GPN-0003_TRC-CR_X8-01 %%01OSPF/4/CONFLICT_ROUTERID_INTF(l):CID=0x8082047e;OSPF router ID conflict is detected on the interface.(ProcessId=801, RouterId=10.0.0.10, AreaId=0.0.0.0, InterfaceName=GigabitEthernet6/0/11.801, IpAddr=10.0.0.22, PacketSrcIp=10.0.0.10)
    ...
    def end_to_end_processing_single_live_message(self, json_string_live_message):
